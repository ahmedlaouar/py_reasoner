...
if __name__ == '__main__':
    input_filename = "bench_prepa/dataset.01/DAGs_with_bnlearn/pos500_melancon_inc_.txt"
    output_filename = "bench_prepa/dataset.01/DAGs_with_bnlearn/pos500_melancon.txt"
