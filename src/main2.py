...
if __name__ == "__main__":
    ...
    data_paths = ["bench_prepa/dataset_small_u1/university0.5_p_0.00001.db"] #,"bench_prepa/dataset_small_u1/university0.5_p_0.000005.db"  
    # , "bench_prepa/dataset_small_u1/university0.5_p_0.00005.db", "bench_prepa/dataset_small_u1/university0.5_p_0.0005.db", "bench_prepa/dataset_small_u1/university0.5_p_0.001.db"

    #for data_path in data_paths:
    #    conflicts_helper(ontology_path, data_path)
    relative_path = "bench_prepa/DAGs/DAGs_with_bnlearn/ordered_method/"
    
    pos_dir_paths = ["pos50/", "pos100/", "pos250/", "pos500/", "pos750/", "pos1000/"] #, "pos2500/"
