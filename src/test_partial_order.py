...
from dl_lite.new_repair import check_all_dominance, check_assertion_in_cpi_repair, compute_cpi_repair, compute_supports, conflict_set, generate_assertions_naive, generate_possible_assertions, generate_possible_assertions_rec, get_all_assertions, is_strictly_preferred, new_check_assertion_in_cpi_repair
...
try:  
    ...
    print("The size of the cpi_repair using method 2: ",verif_count)
